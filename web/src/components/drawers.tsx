...
import { formatArmyArrears, formatMoney, formatSignedMoney, populationWanKou, qualitativeArmyStat } from "../format";
    ...
    <RightDrawer open={open} onClose={onClose} title="省份" icon={<MapPinned size={17} />} extraClass="right-drawer-region">
      ...
      {selected && (
        <div className="right-drawer-detail">
          ...
          <table className="intel-table">
            <tbody>
              <tr><th>人口</th><td>{populationWanKou(selected.population_wan)}</td><th>田亩</th><td>{selected.registered_land}万亩</td></tr>
