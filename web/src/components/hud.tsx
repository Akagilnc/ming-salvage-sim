...
export const HUD_SLOTS = {
  ...
  导航: {
    政: { left: "91.4%", top: "19.1%" },
    吏部: { left: "91.4%", top: "27.1%" },
    省份: { left: "91.4%", top: "34.7%" },
    兵部: { left: "91.4%", top: "42.0%" },
    户部: { left: "91.4%", top: "50.7%" },
    工部: { left: "91.4%", top: "58.3%" },
    礼部: { left: "91.4%", top: "66.0%" },
    后宫: { left: "91.4%", top: "73.8%" },
  },
  命令: {
