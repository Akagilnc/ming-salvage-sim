...
export const HUD_SLOTS = {
  ...
  导航: {
    ...
    吏部: { left: "90.4%", top: "27.4%" },
    省份: { left: "90.4%", top: "35.9%" },
    兵部: { left: "90.4%", top: "43.6%" },
    户部: { left: "90.4%", top: "51.2%" },
    工部: { left: "90.4%", top: "58.2%" },
    礼部: { left: "90.4%", top: "65.6%" },
    后宫: { left: "90.4%", top: "72.4%" },
  },
  命令: {
    奏疏: { left: "8.5%", top: "74.0%", width: "14%", height: "20%" },
    邸报: { left: "26.2%", top: "74.5%", width: "14%", height: "20%" },
    密令: { left: "43.0%", top: "74.0%", width: "14%", height: "20%" },
    史册: { left: "57.1%", top: "74.5%", width: "14%", height: "20%" },
    拟诏: { left: "76.1%", top: "75.0%", width: "14%", height: "20%" },
  },
  命令文字: {
    奏疏: { left: "15.5%", top: "94.6%" },
    邸报: { left: "33.2%", top: "94.6%" },
    密令: { left: "50.0%", top: "94.6%" },
    史册: { left: "64.1%", top: "94.6%" },
    拟诏: { left: "83.1%", top: "94.6%" },
  },
