...
Version: **2026-07-18.1**（owner 令补入 `sol@low` / `sol@high`——sol-low 修理工的判官点名替补档；claude-cheap 路线配套）
...
| `sol@low` | codex 5h/周 | `gpt-5.6-sol-low` | 机械修 / 省额度默认档 | claude-cheap 路线 coder/coderFix/fixer 默认；别名 `gpt-5.6-sol-low` |
| `sol@high` | codex 5h/周 | `gpt-5.6-sol-high` | 修不动时的判官点名升级档 | 替补链 sol@low → sol@med → sol@high；别名 `gpt-5.6-sol-high` |
