...
| 6 | `docs/character-office-changes.md`（character_offices 解禁只写 +「本回合即可召见」改写） | 已回注 + 本片补强解禁只写 | 「本回合即可召见」：`docs/character-office-changes.md:36`；解禁只写：`docs/character-office-changes.md:139` |
