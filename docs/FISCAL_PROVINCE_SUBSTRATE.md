...
| `起运定额`(起运到京上限) | 40/月 | 陕西多存留充边防、起运京师少(三边自用 + 倚京运补) | **~3/月**(占位偏高;与其余缩小后量级对齐,余皆存留省内) |
| `拨付gross`(京运补) | 0 | 三边京运年例 ~52万/年(延绥35.7+宁夏3.5+甘肃5.1+固原6.3,Src[2]) | **~4/月** |
...
- **[2] 三边京运年例（军饷）** = [清華學報 53(4) 明末九边京运](https://thjcs.site.nthu.edu.tw/var/file/452/1452/img/5067/z-ww815-04.pdf)、[中国经济史论坛·明代九边](http://economy.guoxue.com/?p=6645)：延绥 ~35.7万 + 宁夏 ~3.5万 + 甘肃 ~5.1万 + 固原 ~6.3万 ≈ **三边京运 ~52万两/年**（九边京运总 >300万）。
