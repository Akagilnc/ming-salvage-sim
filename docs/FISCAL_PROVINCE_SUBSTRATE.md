...
| `起运定额`(=送京/解边起运上限,**封顶总实征起运=正赋+三饷**) | 40/月 | **三饷须全额解京/边**→起运定额必 **≥三饷应征**;陕西正赋多供本镇边军(记省内/存留)、正赋起运少。⚠️会计录起运/存留比待一手核 | **开局≈3.5/月**(辽饷2.5 全解 + 正赋起运~1);**须随三饷事件同步上调**(1631→≥3.3、剿/练再加),否则超额三饷被困省内、违「三饷全解」史实(gemini PR#113) |
...
- **[3] 三饷（开征年/率/总额）** = [维基·三饷](https://zh.wikipedia.org/zh-hans/%E4%B8%89%E9%A4%89)：辽饷 1618 起（万历末平均每亩九厘 → 崇祯四年 1631 一分二厘，全国 520→660万）/ 剿饷 崇祯十年 1637、280万/年、1640 停 / 练饷 崇祯十一至十二年 1638–39、730万/年。
