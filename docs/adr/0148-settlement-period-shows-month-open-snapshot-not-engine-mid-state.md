...
〔重构衔接：本 ADR 的月初快照口径保留；分段落账、收尾与恢复见 [0157](0157-v2-month-waits-for-exhausted-model-call-recovery.md)。〕

〔重构呈现统一见 [0158](0158-v2-frontend-receives-audience-month-and-recovery.md)，此处不另定义推演卷或月报。〕
