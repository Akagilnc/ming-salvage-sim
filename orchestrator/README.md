...
only then self-report judge three-state. Online Review worker is the sole owner
of GH query/wait/evidence and side effects (#1145); Runner never replays residual
cargo after the Action returns. There is no mechanical round cap (#940 / #934 ID-012).
