  ...
  async dispatchWorker(
    ...
    return {
      ...
      output: {
        ...
        status: "pr_opened",
        pr: "https://github.com/test/repo/pull/451",
  ...
  const backend = new DogfoodCmrFamilyBackend("module-declaration-head", [], [
    ...
    cmrOutput,
    {
      ...
      output: {
        ...
        status: "pr_opened",
        pr: "https://github.com/test/repo/pull/287",
  ...
  const backend = new DogfoodCmrFamilyBackend("legacy-disposition-head", [], [
    ...
    },
    {
      ...
      output: {
        ...
        status: "pr_opened",
        pr: "https://github.com/test/repo/pull/288",
  ...
  const backend = new DogfoodCmrFamilyBackend("final-legacy-head", [], [
    ...
    },
    {
      ...
      output: {
        ...
        status: "pr_opened",
        pr: "https://github.com/test/repo/pull/289",
  ...
  const backend = new DogfoodCmrFamilyBackend("route-accounting-head", [], [
    ...
    },
    {
      ...
      output: {
        ...
        status: "pr_opened",
        pr: "https://github.com/test/repo/pull/376",
    ...
    [
      ...
      cmr,
      {
        ...
        output: {
          ...
          status: "pr_opened",
          pr: "https://github.com/test/repo/pull/377",
          prHead: "closure-head",
        },
      },
    ],
  ...
  const backend = new DogfoodCmrFamilyBackend("suppression-head", [], [
    ...
    cmrOutput,
    {
      ...
      output: {
        ...
        status: "pr_opened",
        pr: "https://github.com/test/repo/pull/378",
  ...
  const backend = new DogfoodCmrFamilyBackend("provider-pass-head", [], [
    ...
    },
    {
      ...
      output: {
        ...
        status: "pr_opened",
        pr: "https://github.com/test/repo/pull/379",
  ...
  const backend = new DogfoodCmrFamilyBackend("family-head", [], [
    ...
    convergedCmr,
    {
      ...
      output: {
        ...
        status: "pr_opened",
        pr: "https://github.com/test/repo/pull/380",
        prHead: "family-head",
        degradedReviews: [
          {
