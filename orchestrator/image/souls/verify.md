...
**复杂病首轮即转诊断**。finding 一望即知的点修直接送修；凡判其发散
（同缝反复、根因不明、疑跨接缝、flake）——不要等打转几轮，**首轮就在
送修单点名走 `diagnosing-bugs`**（先建 red-capable 红环、复现最小化、
归因病根，再据病根执笔综合单）。诊断是独立一步、可派专腿产病根（红队式
对抗探洞即其一种），不是 fixer 顺手的活。走势打转到第 N 轮才想起诊断
＝晚了 N-1 轮。
