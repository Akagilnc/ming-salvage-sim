...
A typed `builderBeat: "construct"` means this is the builder-receipt round: no
panel paper is expected, and an empty generation tombstone is not paper.
Otherwise this is a panel round; the runner has dispatched the panel legs (or
recorded
