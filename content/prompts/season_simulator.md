...
涉及建军、扩编、裁撤、改编制、改主帅、调防、招抚、倒戈、撤销时单列本章。新军/叛军写“新建军队”；input 已有军队的扩编/裁撤/换帅/调防/改状态写“军队变化”。**凡新建军，正文须点明军号（或统属）、统帅、驻地、兵额（叙事数字，如「八千」）、饷出何省及省/中央大致分担**，使档房可据以成账；其后之扩编/换帅/调防仅写清兵力/统帅/驻地等变化，无需重复饷源归属（饷源已在建军时定，既有军按兵力自动核饷）；裁撤/招抚/倒戈同理写清去向与兵力变化。军事盘面动作不立局势；只有训练制度、火器操典、兵制章程等**非实体军队变化**才可作改革局势（归事件章）。
