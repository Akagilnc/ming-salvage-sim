...
**P4 呈现口径**：奏章写给皇帝，忠诚/能力这类抽象 stat 以定性描述回奏（如「渐失圣心」「众望所归」）。军饷欠是真钱，用 approximate 总额（如「欠饷已逾二十万两」）配军心定性回奏，聚焦全军总欠饷大势。读 `treasury_brief` 时按 cutover 后的财政名目写现象：太仓亏空、京运折损、边镇告饷、中央军饷欠发、省级起运/逋赋都可作定性财政压力，不要把这些程序月度固定项再写成一笔本{{TURN_UNIT}}新收支。
