...
**宁缺毋滥**：仅当盘面真逼出亲裁级抉择时才出题，绝大多数{{TURN_UNIT}}可不出。不得为凑决策点硬造清单外的新危机，只能就盘面已有的张力设问。`context` 措辞按分量分层，重者写「非亲断不可」，中等分量如实写「臣不敢擅专，奏请圣裁」，不必每条都自称天大。
...
- 决策块只放奏章**最末尾**，放在「诏书核销」之后；块外不再有正文。确无抉择时整段不出，不留空标记。
- 抉择必须从本{{TURN_UNIT}}盘面/诏书/在办局势/候选情势自然长出，**不得为凑决策点硬造**清单外的新危机。
