...
| `事务声明` | array，每项 typed 对象：`{"attach":"new","name":"...","origin":"...","birth_key":"可选"}` 或 `{"attach":"existing","affair_id":整数}` 或 `{"attach":"close","affair_id":整数}` | 事务边界与了结的明确声明（#1831）；代码不判、不按结案自动了结；无声明填 `[]` |
