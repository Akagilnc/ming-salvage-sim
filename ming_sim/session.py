...
class GameSession:
    ...
    @staticmethod
    def _project_action_reports(
        answer: str, actions: Dict[str, Any],
    ) -> tuple[str, list[str]]:
        """Project LLM reports and expose typed evidence of what reached the answer."""
    ...
    def _cli_backend_fallback_actions(
        ...
        result.answer, _presented = GameSession._project_action_reports(
            result.answer or "", res,
        )
